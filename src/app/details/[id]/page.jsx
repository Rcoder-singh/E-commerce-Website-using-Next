        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
            ...
            <div className="text-[#161616] space-y-6">
              ...
              <p className="text-xl">${productData?.price}0</p>
            </div>
            <p className="text-gray-400 text-[14px]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste sunt
              deserunt quos perferendis incidunt ipsum non ipsa cumque dicta
              nulla voluptates numquam, illo, ratione temporibus excepturi,
              suscipit molestiae commodi fuga.
            </p>
            <p className="text-gray-400 text-[14px] ">20 in stocks</p>
